package com.katherine_qj.saver.ui.guillotine.animation;
...
import com.katherine_qj.saver.ui.guillotine.util.ActionBarInterpolator;
import com.katherine_qj.saver.ui.guillotine.util.GuillotineInterpolator;
...
public class GuillotineAnimation {
    ...
    public static class GuillotineBuilder {
        ...
        public com.katherine_qj.saver.ui.guillotine.animation.GuillotineAnimation build() {
            return new com.katherine_qj.saver.ui.guillotine.animation.GuillotineAnimation(this);
        }
    }
}
